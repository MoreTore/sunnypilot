...
void PairingQRWidget::refresh() {
  ...
  QString qrString = "https://stable.konic.ai/?pair=" + pairToken;
...
PairingPopup::PairingPopup(QWidget *parent) : DialogBase(parent) {
  ...
  hlayout->addLayout(vlayout, 1);
  {
    ...
    )").arg(tr("Go to https://stable.konic.ai on your phone"))
    .arg(tr("Click \"add new device\" and scan the QR code on the right"))
    .arg(tr("Bookmark stable.konic.ai to your home screen to use it like an app")), this);
...
PrimeAdWidget::PrimeAdWidget(QWidget* parent) : QFrame(parent) {
  ...
  QLabel *description = new QLabel(tr("Become a comma prime member at stable.konic.ai"));
...
SetupWidget::SetupWidget(QWidget* parent) : QFrame(parent) {
  ...
  QLabel* registrationDescription = new QLabel(tr("Pair your device with comma connect (stable.konic.ai) and claim your comma prime offer."));
